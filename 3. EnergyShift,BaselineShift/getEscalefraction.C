...
void getEscalefraction()
{
       
      TFile * inputfile = new TFile("./int_outputFigs.root");//straight2_outputFigs_75bin.root");
	 ...
	 cout<<" sum : "<<sum<<endl;
      ...
      TFile* outputFile = new TFile("Escalefraction.root","RECREATE");
