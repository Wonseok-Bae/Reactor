...

{
  ...
  for(int i=50;i>=0;i--){bin_x[50-i]=TMath::Power(10.,(-2.3982*i*2/100.));}

  //for(int i=0;i<51;i++){bin_y[i]=TMath::Power(10,(-2 + 3.*i*2/100.));}//dm
  //for(int i=0;i<51;i++){bin_y[i]=TMath::Power(10,(-2 + 3.302*i*2/100.));}//20dm
  ...
  ifstream inContour;
  inContour.open("./NEOS_0807_3.txt");

  ifstream inContourv;
  inContourv.open("./NEOS_0807_3.txt");
  ...
  while(! inContour.eof())
  {
      ...
      */
      ...
      p1_CL->SetBinContent(50-bb,aa,cc-minv);//50-ds,dm,chi2
      p2_CL->SetBinContent(50-bb,aa,cc-minv);
      p3_CL->SetBinContent(50-bb,aa,cc-minv);
      hContour->SetBinContent(50-bb,aa, cc-minv);
